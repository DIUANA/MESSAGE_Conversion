...
* general parameters
    ...
    duration_period2(year_all)      duration of one multi-year period (in years)
    emission_duration_period(year_all)      duration of one multi-year period (in years)
...
* technology input-output mapping and costs parameters
    ...
    main_output_val(node,tec,vintage,year_all,mode,time)  
    main_input_val(node,tec,vintage,year_all,mode,time)     
*    main_rel_val(relation2, node,tec,year_all,mode,time)   
    ...
    var_cost2(node,tec,vintage,year_all,mode)       variable costs of operation (per unit of capacity maintained)
...
* engineering parameters
    ...
    min_utilization_time_factor(node,inv_tec,vintage,year_all,time) time minimum utilization factor
...
*new relation parameters
    relation_upper2(relation2,node,year_all)    upper bound of generic relation
    relation_lower2(relation2,node,year_all)    lower bound of generic relation
    relation_cost2(relation2,node,year_all)     cost of investment and activities included in generic relation
    relation_new_capacity2(relation2,node,year_all,tec)   new capacity factor (multiplier) of generic relation
    relation_total_capacity2(relation2,node,year_all,tec) total capacity factor (multiplier) of generic relation
    relation_activity2(relation2,node,year_all,node,tec,year_all,mode) activity factor (multiplier) of generic relation
;
