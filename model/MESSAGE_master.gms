...
$SETGLOBAL data "MsgData_BLUES_Brasil_1.99_IX_79_15C_wCost"
...
$SETGLOBAL SLACK_RELATION_BOUND_UP2 "*"
$SETGLOBAL SLACK_RELATION_BOUND_LO2 "*"

$SETGLOBAL SLACK_MUF "*"
$SETGLOBAL SLACK_MUF_TIME "*"
$SETGLOBAL SLACK_CAP_CON "*"
$SETGLOBAL SLACK_CAP_LAND "*"
$SETGLOBAL SLACK_EMISSION "*"
$SETGLOBAL SLACK_EXT_BOUND_UP "*"
*----------------------------------------------------------------------------------------------------------------------*
* launch the MESSAGEix or MESSAGEix-MACRO run file with the settings as defined above                                      *
*----------------------------------------------------------------------------------------------------------------------*

$SETGLOBAL in "data/%data%.gdx"
$IFTHEN %comment%==""
